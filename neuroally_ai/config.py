# neuroally_ai/src/neuroally_ai/config.py
"""
Configuration management for NeuroAlly AI.
...
class Settings(BaseSettings):
    ...
    APP_NAME: str = Field(default="NeuroAlly AI")
    DESCRIPTION: str = Field(default="LLM project scaffold")
    VERSION: str = Field(default="0.1.0")  # From cookiecutter.json
